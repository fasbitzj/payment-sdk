...
import com.ucloudlink.api.FileItem;
...
public abstract class WebUtils {
    ...
    private static final String     DEFAULT_CHARSET = UcloudlinkConstants.CHARSET_UTF8;
     ...
     * @throws IOException
     */
    public static String doPostJson(String url, String json, String charset, int connectTimeout, int readTimeout) throws IOException {
        String ctype = "application/json;charset=" + charset;
        byte[] content = {};
        if (json != null && !StringUtils.isEmpty(json)) {
            content = json.getBytes(charset);
        }
        return doPostJson(url, ctype, content, connectTimeout, readTimeout);
    }

    public static String doPostJson(String url, String ctype, byte[] content,
                                    int connectTimeout, int readTimeout) throws IOException {
        ...
        try {
            try {
                ...
                UcloudlinkLogger.logCommError(e, url, map.get("app_key"), map.get("method"), content);
                throw e;
            }
            try {
    ...
    private static HttpURLConnection getConnection(URL url, String method,
                                                   String ctype, String acceptType) throws IOException {
        HttpURLConnection conn = null;
    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        try {
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                UcloudlinkLogger.logCommError(e, url, map.get("app_key"), map.get("method"), params);
                throw e;
            }
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                UcloudlinkLogger.logCommError(e, conn, map.get("app_key"), map.get("method"), params);
                throw e;
            }
    ...
    public static String doGet(String url, Map<String, String> params,
        ...
        try {
            ...
            try {
                ...
                Map<String, String> map = getParamsFromUrl(url);
                UcloudlinkLogger.logCommError(e, conn, map.get(""), map.get("method"), params);
                throw e;
            }
